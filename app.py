from PySide6.QtWidgets import (QApplication, QMainWindow, QLabel, QVBoxLayout, QHBoxLayout, QWidget, 
                               QTextEdit, QFileDialog, QLineEdit, QStackedWidget, QSizePolicy, QPushButton)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.sample_matching_box.mousePressEvent = lambda event: self.select_task(0)
        ...
        self.clustering_box.mousePressEvent = lambda event: self.select_task(1)
        task_layout.addWidget(self.clustering_box)
        
        main_layout.addLayout(task_layout)

        # Sample Matching Layout
        ...
        main_layout.addWidget(self.task_stacked_widget)
