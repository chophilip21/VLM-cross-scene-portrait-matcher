from PySide6.QtWidgets import (QApplication, QMainWindow, QLabel, QVBoxLayout, QGridLayout, QWidget, QPushButton, QSizePolicy, QHBoxLayout)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.title_label.setFont(QFont("Arial", 24))  # Set initial font size
        ...
        self.clustering_color = ["#2cf0ac", "#94f463"]
    ...
    def create_task_button(self, svg_path, button_text, color1=None, color2=None):
        ...
        # add SVG icons to the button. Make it borderless and transparent, and inverse black and white.
    ...
    def handle_box_click(self):
        ...
        self.sample_match_box.setStyleSheet(f"background-color: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 {self.matching_color[0]}, stop:1 {self.matching_color[1]});; border: 2px solid black;")

        self.cluster_box.setStyleSheet(f"background-color: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 {self.clustering_color[0]}, stop:1 {self.clustering_color[1]});; border: 2px solid black;")
